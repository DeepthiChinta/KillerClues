<?php
session_start();
$mysqli = new mysqli('localhost', 'root', '', 'elitmusdb');
...
$query = "SELECT score_3, score_7, score_9, score_11, score_17 FROM users WHERE username = '$u'";
...
$sql = "UPDATE users SET tot_score = '$val' WHERE username = '$u' ";
$res = $mysqli->query($sql);

$s1 = "UPDATE users SET tot_time = '$sum' WHERE username = '$u' ";
$res = $mysqli->query($s1);

echo '<script> 
            window.location.href="Session_score.php";
    </script>';
